...
SEMI, EOF, MOD, LBRACE, RBRACE,DOUBLE,STRING,BOOL,MAIN,COMMA,LBRACKET, RBRACKET, VAR, COLON,WHITE_SPACE) = (
...
RESERVED_KEYWORDS = {
  ...
  'WHITE_SPACE': Token('WHITE_SPACE', 'WHITE_SPACE')
...
class Lexer(object):
    ...
    def number(self):
        ...
        if self.current_char == '.':
            ...
            token = Token('DOUBLE', float(result))
        else:
...
class Parser(object):
    ...
    def program(self):
        ...
        self.eat(MAIN)
        lp = self.get_next_token()
        rp= self.get_next_token()
        ...
        # var_node = self.variable()   /// add () after main
    ...
    def statement_list(self):
        ...
        results = [node] # first stored array element 
    ...
    def statement(self):
        ...
        if self.current_token.type == self.type_spec().token:
